...
@Component({
  selector: 'app-main-labtest',
  templateUrl: './main-labtest.component.html',
  styleUrls: ['./main-labtest.component.css']
})
export class MainLabtestComponent implements OnInit {
  ...
  addlabtestform(){
    this.route.navigate(['addlabtestFormComponent'])
  }
  backtomain(){
    history.back();
  }
